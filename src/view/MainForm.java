...
public class MainForm extends javax.swing.JFrame {
    ...
    private void valtozas(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_valtozas
        btnIndit.setEnabled(true);
    }//GEN-LAST:event_valtozas

    public void jatek(){
        int rnd = new Random().nextInt(koPapirOllo.length);
        gep=koPapirOllo[rnd];
        if ((koPapirOllo[rnd].equals("kő") && jRadioButton1.isSelected()) || (koPapirOllo[rnd].equals("papír") && jRadioButton2.isSelected()) || (koPapirOllo[rnd].equals("olló") && jRadioButton3.isSelected())) {
            nyertes="Egyenlő";
        }else if((koPapirOllo[rnd].equals("kő") && jRadioButton2.isSelected()) || (koPapirOllo[rnd].equals("papír") && jRadioButton3.isSelected()) || (koPapirOllo[rnd].equals("olló") && jRadioButton1.isSelected())){
            nyertes="Játékos";
        }else if((koPapirOllo[rnd].equals("kő") && jRadioButton3.isSelected()) || (koPapirOllo[rnd].equals("papír") && jRadioButton1.isSelected()) || (koPapirOllo[rnd].equals("olló") && jRadioButton2.isSelected())){
            nyertes="Gép";
        }
    }
    ...
    private int felugro(String uzenet) {
        return JOptionPane.showConfirmDialog(rootPane, uzenet, "Kérdés", JOptionPane.OK_CANCEL_OPTION, JOptionPane.INFORMATION_MESSAGE);
    }
    ...
    private void btnInditActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnInditActionPerformed
        ...
        jatek();
        jLabel3.setText("gép választása: "+gep);
        jLabel4.setText("kör nyertese: "+nyertes);
